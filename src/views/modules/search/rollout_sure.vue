    ...
    <el-dialog :visible.sync="dialogVisible" :close-on-click-modal="false">
      <el-form :model="dataForm" ref="fileRef" class="demo-ruleForm"
        ...
        <el-row :gutter="20">
          ...
          >
          <el-col :span="10"
            ><el-form-item label="所在党支部:" prop="partyBranchesId">
              <span
                v-if="
                  partyTree[
        ...
        <el-row :gutter="20"
          ><el-col :span="10"
            ><el-form-item label="转出时间:" prop="rolloutTime">
              <span>{{ timeFormat(dataForm.rolloutTime) }}</span>
            </el-form-item></el-col
          ></el-row
        >
      </el-form>
      ...
      <el-button type="primary" @click="pdfSubmit()">下载pdf</el-button>
    </el-dialog>
    <!--pdf下载-->
    <!--<el-dialog :close-on-click-modal="false" :visible.sync="pdfVisible">
      ...
      if (this.dataForm.id) {
        this.$http({
          ...
          if (data && data.code === 0) {
            ...
            this.dataForm.rolloutTime = data.fileAllInfo.rolloutTime;
